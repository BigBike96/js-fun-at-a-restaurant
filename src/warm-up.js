...
var vegetables = ["carrot", "squash", "turnup", "lettuce", "cabbage"];
...
var fruits = ["bannana", "apple", "orange", "strawberry", "tomato", "lemon", "lime"];
...
var groceryStore = {name: "King Soopers", isOpen: true, isStocked: true, pharmacyOpen: true};
